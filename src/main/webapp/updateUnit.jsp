<%-- 
    Document   : updateUnit
    Created on : 24-Feb-2024, 21:56:05
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <div id="formProduct">
            <form id="formCreatePro" method="post" action="UnitController">
                <div class="input-control">
                    <label>UnitID</label>
                    <input type="text" id="UnitID" name="UnitID" value="<%= unitOld.getUnitID()%>" readonly/>
                </div>
                <div class="input-control">
                    <label>UnitName</label>
                    <input type="text" id="UnitName" name="UnitName" value="<%= unitOld.getUnitName()%>"/>
                </div>
                <button type="submit" name="btnUpdateUnit">Update</button>
            </form>
        </div>
