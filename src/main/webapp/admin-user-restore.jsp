...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            String msggSuccess = (String) session.getAttribute("RestoreSuccess");
            if (msggSuccess != null) {
        %>
        <script>
            // S? d?ng SweetAlert ?? hi?n th? th�ng b�o
            alertify.success("Account restore successfully");
        </script>
        <%
                // X�a th�ng b�o sau khi hi?n th?
                session.removeAttribute("RestoreSuccess");
            }
        %>
